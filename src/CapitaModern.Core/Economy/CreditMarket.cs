...
public sealed class CreditMarket
{
    ...
    /// <summary>За какой чертой нагрузки перестают давать вовсе, в процентах. Та же
    /// черта, за которой начинается отказ платить: дальше заём не сделка, а подарок.</summary>
    public const int SafeBurden = 400;
