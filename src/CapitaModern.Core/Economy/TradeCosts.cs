...
public sealed class TradeCosts
{
    ...
    /// <summary>Какая доля цены перевозки — само топливо, в процентах.</summary>
    /// <remarks>Остальное это судно, команда, порт и страховка. У морских перевозчиков
    /// бункер около трети операционных расходов, у автоперевозчиков дизель примерно
    /// столько же. Раньше в топливо переводилась вся цена перевозки, и на дорогу уходило
    /// 62% нефти мира против настоящей четверти.</remarks>
    public const int FuelInFreight = 30;
