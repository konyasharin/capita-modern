...
public sealed class Elasticity
{
    ...
    /// <summary>Продавать можно и часть рабочего запаса, но не всё подряд.</summary>
    /// <remarks>Спрос при дешевизне может вырасти хоть вдесятеро — деньги на это есть.
    /// А предложение упирается в склад: с двадцатикратным множителем страна со слабой
    /// валютой каждый тик сбрасывала всё до нуля, и мировой экспорт выходил втрое выше
    /// настоящего.</remarks>
    public const int MaxSupplyFactor = 300;
