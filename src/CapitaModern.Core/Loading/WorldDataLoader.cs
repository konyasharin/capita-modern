...
public static class WorldDataLoader
{
    ...
    /// <remarks>
    /// Ровно норма <see cref="Prices.TargetCoverDays"/>, по которой стоит цена: мир должен
    /// начинать партию там, где заводам не нужно ни добивать склад, ни разгружать его.
    ///
    /// Было вдвое. При восьмидесяти сутках склады мира пухли со стартовых 28 трлн до 148 —
    /// годовой выпуск, лежащий на полке, — и правило загрузки глушило заводы: тринадцать
    /// процентов мировой мощности терялось на полном складе.
    /// </remarks>
