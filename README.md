...
- [`10-trade.md`](./docs/10-trade.md) — план торговли: мировой рынок, деньги, порядок работ
- [`11-money.md`](./docs/11-money.md) — план денег: курс, резервы, долг
- [`12-labour.md`](./docs/12-labour.md) — план труда: эффективность, зарплаты, внутренний оборот
...
| `data/map/population.json` | население стран на 1 января 2020 | 4 КБ |
