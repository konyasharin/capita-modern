 ...
 *
 *  Выводится из равенства: в стройке занято около 7% мировой рабочей силы — 240 млн
 *  человек, — и строят они весь капитал за срок его службы. Менялась, когда услуги
 *  разошлись по отраслям: у транспорта техника живёт двенадцать лет, а не сорок, и
 *  капитал стал обновляться вдвое чаще. Работа не входит в buildCost: то мешок цемента, а это
 *  люди. Их цена — местная зарплата, поэтому в бедной стране та же стройка обходится
 *  дешевле, и это настоящее преимущество. */
const MAN_DAYS_PER_THOUSAND = 6.05
